...
if(amysBirthYear === brittanisBirthYear){
  console.log("Amy and Brtittani were born in the same year.")
} else {
...
if(temperature > 80 && rain === true){
  ...
  console.log("Wear a winter coat and carry an umbrella.")
...
while (score < 7){
  console.log(`Your score is not high enough. Your score is ${score}. You need at least a 7 to pass.`)
  score += 1
}
